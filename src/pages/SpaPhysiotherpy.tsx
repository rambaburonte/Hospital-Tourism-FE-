...
//           {filteredSpas.map(spa => (
//             <div key={spa.spaId} className="bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all duration-300">
//               <img 
//                 src={spa.spaImage || 'https://via.placeholder.com/300x200?text=Spa+Image'} 
//                 alt={spa.spaName} 
//                 className="w-full h-36 object-cover rounded-t-xl" 
//               />
//               <div className="p-4">
//                 <h3 className="text-lg font-semibold text-gray-800 truncate">{spa.spaName}</h3>
//                 <div className="flex items-center mt-2">
//                   <Star className="w-4 h-4 text-yellow-500 fill-current" />
//                   <span className="ml-1 text-sm text-gray-500">{spa.rating || 'Not rated'}</span>
//                 </div>
//                 <p className="mt-2 text-sm text-gray-600 line-clamp-2">{spa.spaDescription || 'No description provided.'}</p>
//                 <p className="mt-2 text-xs text-gray-400 flex items-center">
//                   <MapPin className="w-4 h-4 text-gray-400 mr-1" /> 
//                   <span className="truncate">{spa.address || 'No address'}</span>
//                 </p>
//                 <div className="mt-4">
//                   <Link 
//                     to={`/viewspas/${spa.spaId}`} 
//                     className="inline-block bg-blue-500 text-white text-sm px-3 py-1.5 rounded-lg hover:bg-blue-600 transition-colors"
//                   >
//                     {getTranslatedText('View Services', 'Explorar Más', 'Découvrir Plus')}
//                   </Link>
//                 </div>
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
//           {filteredPhysios.map(physio => (
//             <div key={physio.physioId} className="bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all duration-300">
//               <img 
//                 src={physio.physioImage || 'https://via.placeholder.com/300x200?text=Physio+Image'} 
//                 alt={physio.physioName} 
//                 className="w-full h-36 object-cover rounded-t-xl" 
//               />
//               <div className="p-4">
//                 <h3 className="text-lg font-semibold text-gray-800 truncate">{physio.physioName}</h3>
//                 <div className="flex items-center mt-2">
//                   <Star className="w-4 h-4 text-yellow-500 fill-current" />
//                   <span className="ml-1 text-sm text-gray-500">{physio.rating || 'Not rated'}</span>
//                 </div>
//                 <p className="mt-2 text-sm text-gray-600 line-clamp-2">{physio.physioDescription || 'No description provided.'}</p>
//                 <p className="mt-2 text-xs text-gray-400 flex items-center">
//                   <MapPin className="w-4 h-4 text-gray-400 mr-1" /> 
//                   <span className="truncate">{physio.address || 'No address'}</span>
//                 </p>
//                 <div className="mt-4">
//                   <Link 
//                     to={`/viewphysios/${physio.physioId}`} 
//                     className="inline-block bg-blue-500 text-white text-sm px-3 py-1.5 rounded-lg hover:bg-blue-600 transition-colors"
//                   >
//                     {getTranslatedText('Book now', 'Explorar Más', 'Découvrir Plus')}
//                   </Link>
            ...
            <div key={spa.spaId} className="bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all duration-300">
              ...
              <div className="p-4">
                ...
                <div className="mt-4">
                  <Link 
                    to={`/viewspas/${spa.spaId}`} 
                    className="inline-block bg-[#499E14] text-white text-sm px-3 py-1.5 rounded-lg hover:bg-[#3D8211] transition-colors"
                  >
                    {getTranslatedText('View Services', 'Explorar Más', 'Découvrir Plus')}
                  </Link>
                </div>
