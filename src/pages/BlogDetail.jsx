...
const blog = {
  title: 'Pregnancy at 3 Weeks: What’s Happening Before You Even Test Positive?',
  ...
  fullDescription: `
    <p class="text-gray-600 leading-relaxed mb-6">By the third week of pregnancy, most women don’t realise they’re expecting. There are no obvious physical changes, and any symptoms can be subtle or mistaken for PMS (premenstrual symptoms). But key developments are already underway, with hormone levels beginning to rise. At this stage, pregnancy tests may still show a negative result, leaving some unsure of what’s happening. Some may notice mild signs, while others feel no different. With so much going on behind the scenes, it’s natural to wonder what to expect.</p>
    <p class="text-gray-600 leading-relaxed mb-6">This blog explores the earliest changes in the body, embryo development, and when a test is most likely to show a positive result. Let’s start with the first signs of pregnancy.</p>
    ...
    <p class="text-gray-600 leading-relaxed mb-6">Many people don’t realise they’re pregnant in the first few weeks, but the body has already started changing. Some experience early symptoms, while others feel completely normal. Signs can vary, but a few common ones include:</p>
    <ul class="list-disc pl-6 mb-6 text-gray-600">
      <li><strong>Fatigue</strong> – Energy levels drop as the body adjusts to hormonal changes.</li>
      <li><strong>Breast tenderness</strong> – Increased hormone levels can make breasts feel swollen or sensitive.</li>
      <li><strong>Mild cramping</strong> – Some feel slight cramps as the uterus starts preparing for pregnancy.</li>
      <li><strong>Spotting</strong> – Light bleeding, known as implantation spotting, can occur when the fertilised egg attaches to the uterus.</li>
      <li><strong>Nausea</strong> – Some may feel queasy, though morning sickness typically starts later.</li>
      <li><strong>Increased urination</strong> – Rising hormone levels can make trips to the bathroom more frequent.</li>
    </ul>
    ...
    <h2 class="text-3xl font-extrabold text-gray-800 mb-4 tracking-tight">What’s Happening in Your Body by the 3rd Week of Pregnancy?</h2>
    ...
    <ul class="list-disc pl-6 mb-6 text-gray-600">
      <li><strong>Human chorionic gonadotropin (hCG)</strong> – This hormone, produced once implantation occurs, signals the body to stop menstruation and sustain the pregnancy. However, hCG levels are still low at this stage.</li>
      <li><strong>Progesterone</strong> – This hormone supports the thickening of the uterine lining, ensuring a suitable environment for the fertilised egg. It also relaxes the uterine muscles to prevent contractions.</li>
      <li><strong>Oestrogen</strong> – This hormone helps regulate other pregnancy hormones and promotes early fetal development.</li>
    </ul>
    ...
    <ul class="list-disc pl-6 mb-6 text-gray-600">
      <li><strong>Inner cell mass</strong> – This will later develop into the embryo.</li>
      <li><strong>Trophoblast</strong> – This outer layer will form the placenta, which provides oxygen and nutrients.</li>
    </ul>
    ...
    <p class="text-gray-600 leading-relaxed mb-6">Mild cramping can be normal in early pregnancy and is often linked to implantation or the uterus beginning to expand. However, if cramps are severe, persistent, or accompanied by heavy bleeding, it’s best to consult a doctor to rule out any complications.</p>
