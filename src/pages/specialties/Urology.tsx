...
//         The Urology Department provides expert care for disorders of the urinary tract and male reproductive system. Our team of urologists, surgeons, and support staff uses advanced diagnostics and treatments to address conditions like kidney stones, prostate issues, and bladder disorders, ensuring personalized care for every patient.
//       </p>
...
const Urology: React.FC = () => {
  ...
  useEffect(() => {
    const fetchHospitals = async () => {
      try {
        const response = await fetch('http://localhost:4545/api/hospitals/specialization/urology');
        if (!response.ok) {
