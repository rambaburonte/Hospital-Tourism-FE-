...
//   return (
//     <div className={`${darkMode ? 'dark' : ''}`}>
//       <div className="flex flex-col items-center justify-center min-h-screen bg-white dark:bg-white overflow-hidden">

//         {/* Theme and Language Toggle */}
//         <div className="fixed top-4 right-4 z-20 flex gap-2">
//           <button
//             onClick={() => setDarkMode(!darkMode)}
//             className="px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-200 text-gray-700 dark:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-300 border border-gray-200 dark:border-gray-300 shadow-sm transition-all duration-300"
//           >
//             {darkMode ? '☀️' : '🌙'}
//           </button>
//           <select
//             value={language}
//             onChange={(e) => setLanguage(e.target.value as Language)}
//             className="px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-200 text-gray-700 dark:text-gray-800 border border-gray-200 dark:border-gray-300 shadow-sm transition-all duration-300"
//           >
...
//         {/* Logo Header */}
//         <div className="w-full bg-white dark:bg-white py-6 sm:py-8 shadow-sm border-b border-gray-100 dark:border-gray-200">
//           <h2 className="text-xl sm:text-2xl font-semibold text-center text-green-800 dark:text-green-700 mb-6">
//             {t.title}
//           </h2>
//           <div className="relative w-full h-32 sm:h-36 overflow-hidden group">
//             <div
...
//                     <div className="absolute inset-0 bg-gradient-to-t from-black/10 to-transparent hover:from-black/20 rounded-lg"></div>
//                   </div>
//                   <p className="mt-2 text-sm text-gray-600 dark:text-gray-500 font-medium truncate">{h.name}</p>
//                 </a>
//               ))}
//             </div>
//           </div>
...
//         <div
//           className="w-full min-h-[75vh] bg-white dark:bg-white relative"
//         >
//           {/* Overlay */}
//           <div className="absolute inset-0 bg-white/90 dark:bg-white/90"></div>
          
//           {/* Content Container */}
//           <div className="relative z-10 flex items-center justify-center min-h-[75vh] px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
//             <div className="text-center max-w-5xl mx-auto">
//               {/* Main Content Card */}
//               <div className="bg-white dark:bg-white rounded-xl shadow-2xl border border-gray-200/50 dark:border-gray-300/50 p-6 sm:p-8 lg:p-12 space-y-6 sm:space-y-8">
                
//                 {/* Header */}
//                 <div className="space-y-4 sm:space-y-6">
//                   <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 dark:text-gray-900 leading-tight">
//                     {t.header}
//                   </h1>
//                   <p className="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-700 leading-relaxed max-w-4xl mx-auto">
//                     {t.description}
//                   </p>
//                 </div>
...
//                   <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 text-left">
//                     {t.points.map((point: string, i: number) => (
//                       <li key={i} className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-lg bg-gray-50/50 dark:bg-gray-100/30 hover:bg-gray-100/50 dark:hover:bg-gray-200/50 transition-all duration-300">
//                         <span className="flex-shrink-0 w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full mt-2"></span>
//                         <span className="text-sm sm:text-base lg:text-lg text-gray-700 dark:text-gray-800 leading-relaxed hover:text-green-600 dark:hover:text-green-500 transition-colors">
//                           {point}
//                         </span>
//                       </li>
//                     ))}
...
const Advertisement: React.FC = () => {
  ...
  const translations: Record<Language, {
    ...
    es: {
      title: 'Nuestros Socios de Salud de Confianza',
      header: 'Tu Viaje hacia una Mejor Salud Comienza Aquí',
      description: 'Experimenta atención médica de clase mundial con nuestras soluciones integrales de salud:',
      points: [
        'Trat Junto a nuestro movimiento por la libertad y la verdad en X, hacemos historia. #Libertad #Verdad',
        'Experiencia Fluida: Soporte completo desde la consulta hasta la recuperación.',
        'Bienestar Holístico: Atención integral con programas de recuperación y bienestar.',
        'Guía Experta: Soporte 24/7 por profesionales de la salud calificados.',
      ],
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="fixed top-4 right-4 z-20 flex gap-2">
            <button
              onClick={() => setDarkMode(!darkMode)}
              className="px-3 py-2 rounded-lg bg-white/10 border border-white/20 backdrop-blur-md text-gray-200 hover:bg-white/20 hover:border-white/50 transition-all duration-300"
            >
              {darkMode ? '☀️' : '🌙'}
            </button>
            <select
          ...
          {/* Logo Header */}
          <div 
            className="backdrop-blur-md bg-white/10 border border-white/20 shadow-lg rounded-xl py-6 sm:py-8 mb-8"
            data-aos="fade-up"
              ...
              >
                {[...hospitals, ...hospitals, ...hospitals, ...hospitals].map((h, index) => (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="inline-block flex-shrink-0 px-4 text-center min-w-[200px] sm:min-w-[250px]"
                  >
                    <div className="relative">
                      <img 
                        src={h.logo} 
                        alt={h.name} 
                        className="h-16 sm:h-24 object-contain mx-auto transition-transform hover:scale-105 rounded-lg shadow-sm" 
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/10 to-transparent hover:from-black/20 rounded-lg"></div>
                    </div>
                    <p className="mt-2 text-sm text-gray-600 font-medium truncate">{h.name}</p>
                  </a>
                ))}
              </div>
            </div>
          ...
          {/* Main Advertisement Section */}
          <div 
            className="backdrop-blur-md bg-white/10 border border-white/20 shadow-lg rounded-xl p-6 sm:p-8 lg:p-12 space-y-6"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            {/* Header */}
            <div className="space-y-4 sm:space-y-6 text-center">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-800 leading-relaxed max-w-4xl mx-auto">
                {t.description}
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto py-4 sm:py-6">
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 text-left">
                {t.points.map((point: string, i: number) => (
                  <li 
                    key={i} 
                    className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300"
                  >
                    <span className="flex-shrink-0 w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full mt-2"></span>
                    <span className="text-sm sm:text-base lg:text-lg text-gray-800 leading-relaxed hover:text-green-600 transition-colors">
                      {point}
                    </span>
                  </li>
                ))}
