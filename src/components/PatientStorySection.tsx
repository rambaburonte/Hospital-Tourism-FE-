        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 shadow-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3">
              <div className="md:col-span-1 bg-[#499E14] text-white p-6">
                <h2 className="text-xl font-bold mb-4">Mrs. Vijay Lakshmi's Recovery from Severe Pneumonia</h2>
                <div className="flex items-center mt-4">
                  <span className="bg-white text-[#499E14] px-2 py-1 rounded text-xs font-medium">#MaxSuccessStory</span>
                </div>
              </div>
              <div className="md:col-span-2 p-6">
                <CardContent className="p-0">
                  <Quote className="h-8 w-8 text-[#499E14] opacity-30 mb-2" />
