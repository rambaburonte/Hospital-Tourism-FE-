...
//             <nav className="flex flexachlor: #fff;
//   flex-col space-y-4">
//               {navItems.map(({ to, label }) => (
//                 <Link
//                   key={to}
...
//           <div
//             className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-lg w-full sm:w-[90%] p-6 sm:p-8 overflow-hidden"
//             style={{
//               backgroundImage: 'linear-gradient(to bottom, rgba(73, 158, 20, 0.7), rgba(58, 126, 16, 0.7))',
//             }}
//             role="dialog"
//             aria-labelledby="popup-title"
//             aria-describedby="popup-desc"
...
//             >
//               <div
//                 className="h-full bg-yellow-400 dark:bg-yellow-300 transition-[width] duration-[5000ms] ease-linear"
//                 style={{ width: `${progress}%` }}
//               />
//             </div>
...
//               <Button
//                 onClick={handleLearnMoreClick}
//                 className="flex-1 bg-[#499E14] hover:bg-[#5ab81a] text-white font-bold rounded-xl py-3 sm:py-2.5 text-base sm:text-lg hover:shadow-lg"
//               >
//                 Learn More
//               </Button>
//               <Button
//                 onClick={handleCloseClick}
//                 className="flex-1 bg-green-500 hover:bg-green-400 text-white font-bold rounded-xl py-3 sm:py-2.5 text-base sm:text-lg hover:shadow-lg"
//               >
//                 Close
//               </Button>
//             </div>
