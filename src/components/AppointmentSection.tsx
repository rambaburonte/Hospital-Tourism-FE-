...
//   //const base_url = 'https://healthtourism-5.onrender.com';
//    const base_url = 'http://localhost:9090'; // Uncomment for local development
//   const apiEndpoints: Record<string, string> = {
//     'Find a Doctor': `${base_url}/api/doctors`,
//     'Book a Test': `${base_url}/api/diagnostics`,
//     'Spa': `${base_url}/spaCenter/all`,
//     'Physiotherapy': `${base_url}/physio/all`,
//     'Locate Hospital': `${base_url}/api/hospitals`,
//     'Hotel Booking': `${base_url}/api/hotels`,
//     'Travel Booking': `${base_url}/api/travel`,
//     'Translators': `${base_url}/api/translators`,
...
//   const base_url = 'http://localhost:9090'; // Updated for local development
//   const apiEndpoints: Record<string, string> = {
//     'Find a Doctor': `${base_url}/api/doctors`,
//     'Book a Test': `${base_url}/api/diagnostics`,
//     'Spa': `${base_url}/spaCenter/all`,
...
//     'Travel Booking': `${base_url}/api/travel`,
//     'Translators': `${base_url}/api/translators`,
//     'Chefs': `${base_url}/api/chefs`, // Updated endpoint
//     'Pharmacy': `${base_url}/cart-item/user/capsules-user`,
//     'pharmacyCategories': `${base_url}/cart-item/user/capsules-user`,
//   };
...
//     return items.filter(
//       (item) =>
//         !item.status || // Include items with status: null
//         (item.status &&
//           typeof item.status === 'string' &&
//           item.status.trim().toUpperCase() === 'ACTIVE')
//     );
...
//     'Hotel Booking': `${base_url}/api/hotels`,
//     'Travel Booking': `${base_url}/api/travel`,
//     'Translators': `${base_url}/api/translators/getAll/traslators`, // Updated endpoint
//     'Chefs': `${base_url}/api/chefs`,
//     'Pharmacy': `${base_url}/cart-item/user/capsules-user`,
//     'pharmacyCategories': `${base_url}/cart-item/user/capsules-user`,
//   };
...
//     return items.filter(
//       (item) =>
//         !item.status || // Include null status
//         item.status.trim().toUpperCase() === 'NULL' || // Include "NUll" status
//         (item.status &&
//           typeof item.status === 'string' &&
//           item.status.trim().toUpperCase() === 'ACTIVE')
//     );
...
//   rating: string;
//   address: string;
//   doctors: Doctor[] | null; // Made optional
//   hospitallocationId: number | null; // Added from API response
//   hospitallocationName: string | null; // Added from API response
//   status: string | null;
// }
...
//     'Locate Hospital': `${base_url}/api/hospitals/getall/hospitals`, // Updated endpoint
//     'Hotel Booking': `${base_url}/api/hotels`,
//     'Travel Booking': `${base_url}/api/travel`,
...
//     if ('physioName' in item) return `/ServiceListingPage/physio/${item.physioId}`;
//     if ('hositalName' in item) return `/OurHospitals/${item.hospitalId}`;
//     if ('hotelName' in item) return `/hotels/${item.hospitalId}`;
//     if ('travelName' in item) return `/travel/${item.travelId}`;
//     if ('translatorName' in item) return `/translatorAndChefList/translator/${item.translatorID}`;
//     if ('chefName' in item) return `/translatorAndChefList/chef/${item.chefID}`;
//     if ('pharmacyName' in item) return `/PharmacyCategoryPage/${item.pharmacyId}`;
...
//     'Find a Doctor': `${base_url}/api/doctors`,
//     'Book a Test': `${base_url}/api/diagnostics`,
//     'Spa': `${base_url}/spaServices/getAll/spaServices`, // Updated endpoint
//     'Physiotherapy': `${base_url}/physio/getall/pysios`,
...
//     return items.filter(
//       (item) =>
//         item.status === undefined || // Include items without status (e.g., SpaService)
//         !item.status || // Include null status
//         item.status.trim().toUpperCase() === 'NULL' || // Include "NUll" status
//         (item.status &&
//           typeof item.status === 'string' &&
...
//     if ('id' in item && 'department' in item) return `/hospitaldoctors/${item.id}`;
//     if ('testTitle' in item) return `/tests/${item.id}`;
//     if ('serviceName' in item) return `/ServiceListingPage/spa/${item.spaCenterId}`; // Updated for SpaService
//     if ('physioName' in item) return `/ServiceListingPage/physio/${item.physioId}`;
//     if ('hositalName' in item) return `/OurHospitals/${item.hospitalId}`;
//   if ('hotelName' in item) return `/hotels/${item.hotelId}`;
//   if ('travelName' in item) return `/travel/${item.travelId}`;
...
//     if ('hositalName' in item) return `/booking/hospital/${item.hospitalId}`;
...
//                                   <button
//                                     onClick={() => handleCategoryClick(category.categoryName)}
//                                     className="mt-4 bg-[#499E14] hover:bg-[#3a7e10] text-white font-semibold py-2 px-4 rounded-lg w-full shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#499E14] focus:ring-offset-2"
...
//                                       className="mt-4 block bg-[#499E14] hover:bg-[#3a7e10] text-white font-semibold py-2 px-4 rounded-lg w-full text-center shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#499E14] focus:ring-offset-2"
...
//         name: item.hotelName,
//         details: item.hotelDetails,
//         description: item.hospitalDescription, // Note: Likely a typo, should be hotelDescription
//         image: item.hotelImage || defaultFields.image,
//       };
//     }
//     if ('travelName' in item) {
