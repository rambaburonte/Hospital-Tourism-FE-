                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="bg-green-600 text-white font-semibold py-3 px-6 rounded-lg w-full shadow-md hover:bg-green-700 transition"
                    ...
                    >
                      <div className="flex flex-col items-center justify-center">
                        <div className="mb-2 bg-gray-100 p-3 rounded-full shadow-sm">
                          {service === 'Find a Doctor' && <User className="h-6 w-6 text-green-600" />}
                          {service === 'Book a Test' && <Calendar className="h-6 w-6 text-green-600" />}
                          {service === 'Spa' && <FaSpa className="h-6 w-6 text-green-600" />}
                          {service === 'Physiotherapy' && <TbPhysotherapist className="h-6 w-6 text-green-600" />}
                          {service === 'Locate Hospital' && <MapPin className="h-6 w-6 text-green-600" />}
                          {service === 'Hotel & GuestHouse Booking' && <Hotel className="h-6 w-6 text-green-600" />}
                          {service === 'Travel Booking' && <Plane className="h-6 w-6 text-green-600" />}
                          {service === 'Translators' && <PaperAirplaneIcon className="h-6 w-6 text-green-600" />}
                          {service === 'Chefs' && <FaUtensils className="h-6 w-6 text-green-600" />}
                          {service === 'Pharmacy' && <Pill className="h-6 w-6 text-green-600" />}
                        </div>
                          ...
                          <>
                                ...
                                ? pharmacyCategories.slice(0, 3).map((category) => (
                                    ...
                                    >
                                      ...
                                      <button
                                        ...
                                        className="mt-4 bg-green-600 text-white font-semibold py-2 px-4 rounded-lg w-full hover:bg-green-700 transition"
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <Link
                                          ...
                                          className="mt-4 block bg-green-600 text-white font-semibold py-2 px-4 rounded-lg w-full text-center hover:bg-green-700 transition"
                            ...
                            <div className="mt-8 text-center">
                              <Link
                                ...
                                className="inline-block bg-green-600 text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:bg-green-700 transition"
