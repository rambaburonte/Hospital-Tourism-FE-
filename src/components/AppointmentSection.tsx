...
//             axios.get<Pharmacy[]>(apiEndpoints['Pharmacy']).then((res) => res.data).catch(() => []),
//             axios.get<PharmacyCategory[]>(apiEndpoints['pharmacyCategories']).then((res) => res.data).catch(() => []),
//           ]);
//           setServiceData((prev) => ({
//             ...prev,
//             Pharmacy: filterActive(pharmaciesRes).slice(0, 6),
//           }));
//           setPharmacyCategories(filterActive(categoriesRes).slice(0, 6));
//         } else {
...
//           switch (type) {
//             case 'Doctor':
//               res = await axios.get<Doctor[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'LabTest':
//               res = await axios.get<LabTest[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'SpaService':
//               res = await axios.get<SpaService[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'Physio':
//               res = await axios.get<Physio[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'Hospital':
//               res = await axios.get<Hospital[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'Hotel':
//               res = await axios.get<Hotel[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'Travel':
//               res = await axios.get<Travel[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'Translator':
//               res = await axios.get<Translator[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             case 'Chef':
//               res = await axios.get<Chef[]>(apiEndpoints[selectedService]).then((res) => res.data).catch(() => []);
//               break;
//             default:
//               res = [];
//           }
...
//         (typeof item.status === 'string' && item.status.trim().toUpperCase() === 'ACTIVE')
//     );
//   };
...
// [Interface definitions remain the same as in your original code]
// For reference, ensure these match your API response structure
interface LabTest {
  id: number;
  testTitle: string;
  testDepartment: string;
