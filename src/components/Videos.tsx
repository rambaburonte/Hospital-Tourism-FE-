...
//   return (
//     <div className="bg-white py-8 px-4 w-full box-border overflow-x-hidden">
...
//                 <button
//                   className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white text-black p-3 rounded-full z-20 shadow-lg hover:bg-gray-100"
...
//                 />
//                 <button
//                   className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white text-black p-3 rounded-full z-20 shadow-lg hover:bg-gray-100"
...
//                 </button>
//               </div>
//               <div className="relative mt-4 w-full px-12">
//                 <button
//                   className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white text-black p-3 rounded-full z-20 shadow-lg hover:bg-gray-100"
...
//                       aria-label={`Select video: ${video.title}`}
//                       aria-selected={selectedVideo.id === video.id}
//                       className="min-w-[180px] bg-white rounded-lg p-2 cursor-pointer"
//                     >
...
//                         <p className="text-xs truncate">{video.doctor}</p>
//                       </div>
//                     </div>
//                   ))}
//                 </div>
...
//           {/* News Section */}
//           <div className="lg:w-1/2 w-full">
//             <h2 className="text-xl font-bold mb-4">Media / News</h2>
//             <div className="relative rounded-lg overflow-visible w-full">
//               <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
//                 <button
//                   className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white text-black p-3 rounded-full z-20 shadow-lg hover:bg-gray-100"
...
//                         <p className="text-xs truncate">{news.description}</p>
//                       </div>
//                     </div>
//                   ))}
//                 </div>
