...
//           <a href="/admin/prescriptions" className="text-gray-600 hover:text-gray-800 text-sm font-semibold">Prescriptions</a>
...
//               <div>
//                 <h2 className="text-lg font-semibold text-gray-800">All Prescriptions</h2>
...
//                 {[...Array(6)].map((_, index) => (
//                   <div key={index} className="bg-transparent p-4 animate-pulse">
...
//                     <p className="text-xs text-gray-600">Mobile: {patient.mobilenum}</p>
//                     <p className="text-xs text-gray-600">Country: {patient.country}</p>
//                     <div className="mt-2">
//                       {patient.prescriptionUrls.map((url, urlIndex) => (
//                         <button
//                           key={urlIndex}
//                           onClick={() => handleViewPrescription(url)}
//                           className="w-full mt-1 px-4 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600"
//                         >
...
//                 className="w-full h-[60vh] border border-gray-200"
...
//                       selectedPrescriptionUrl.endsWith('.pdf') ? 'pdf' : 'jpg'
//                     }`
//                   )
//                 }
...
//         // If it's already a PDF, use the blob directly
//         pdfBlob = blob;
...
//         </div>
//         <div className="flex space-x-6">
//           <Link to="/admin/medicineList" className="text-gray-600 hover:text-gray-800 text-sm">Categories</Link>
//           <Link to="#" className="text-gray-600 hover:text-gray-800 text-sm">Orders</Link>
//           <Link to="/admin/prescriptions" className="text-gray-600 hover:text-gray-800 text-sm font-semibold">Prescriptions</Link>
